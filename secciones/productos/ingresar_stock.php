                    ...
                    <input type="hidden" class="form-control" name="categoria_id" id="categoria_id" value="<?php echo $categoria_id;?>" >
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control camposTabla" name="producto_codigo" id="producto_codigo" required readonly value="<?php echo $producto_codigo;?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control camposTabla" name="producto_marca" id="producto_marca" readonly value="<?php echo $producto_marca;?>" >
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
