                                ...
                                <tbody>
                                    <?php foreach ($lista_carrito as $registro) {?>
                                        <tr id="producto_<?php echo $registro['id']; ?>" style="font-size: 14px;">
                                            ...
                                            <td style="font-weight: 800;"><input type="text" onblur="update_producto(<?php echo $registro['id']; ?>)"   class="precio_menor form-control" id="cantidadPrecioMenor_<?php echo $registro['id']; ?>" name="precio[<?php echo $registro['id']; ?>]" style="width: 77px;" value="<?php echo number_format($registro['precio'], 0, '.', ','); ?>"></td>
                                            <td style="font-weight: 800;"><input type="text" onblur="update_producto(<?php echo $registro['id']; ?>)"   class="precio_mayor form-control" id="cantidadPrecioMayor_<?php echo $registro['id']; ?>" name="precio_venta_xmayor[<?php echo $registro['id']; ?>]" style="width: 77px;" value="<?php echo number_format($registro['precio_venta_mayor'], 0, '.', ','); ?>"> </td>
