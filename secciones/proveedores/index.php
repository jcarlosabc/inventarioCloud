...
?>
      ...
      <div class="card card-primary ">
        <div class="card-header text-center ">
          <h2 class="card-title textTabla">LISTA DE PROVEEDORES  &nbsp; <a href="<?=$url_base?>secciones/proveedores/crear.php" class="btn btn-warning" style="color:black"> Registrar Proveedor </a> </h2>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            ...
            <tbody>
              <?php foreach ($lista_proveedores as $registro) {?>
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info btn-sm" href="editar.php?txtID=<?php echo $registro['id_proveedores']; ?>"role="button" title="Editar">
                      <i class="fas fa-edit"></i>Editar
                    </a>
                    <a class="btn btn-danger btn-sm" href="index.php?txtID=<?php echo $registro['id_proveedores']; ?>" role="button" title="Eliminar">
