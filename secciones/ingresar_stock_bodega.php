...
if(isset($_GET['txtID'])){
    ...
    $sentencia_categoria = $conexion->prepare("SELECT c.categoria_nombre FROM bodega b
        JOIN categoria c ON b.categoria_id = c.categoria_id WHERE b.producto_id=:producto_id");
