...
?>
      ...
      <div class="card card-primary ">
        <div class="card-header text-center ">
          <h2 class="card-title textTabla">LISTA DE EMPLEADOS  &nbsp; <a href="<?=$url_base?>secciones/empleados/crear.php" class="btn btn-warning" style="color:black"> Nuevo Empleado </a>
          </h2>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
              ...
              <?php $count = 0;
               foreach ($lista_producto as $registro) {?>
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info" href="editar.php?txtID=<?php echo $registro['usuario_id']; ?>"role="button" title="Editar">
                        <i class="fas fa-edit"></i>Editar
                    </a>
                    <a class="btn btn-danger"href="index.php?txtID=<?php echo $registro['usuario_id']; ?>" role="button" title="Eliminar">
