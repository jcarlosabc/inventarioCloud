        ...
        <?php foreach ($lista_ventas as $registro) {?>
          ...
          <?php } ?>     
            ...
            <td>
              ...
              <?php } ?>
              <button class="btn btn-danger btn-sm" onclick="confirmDeleteLocal('<?php echo $registro['venta_id']; ?>')" role="button" title="Eliminar">
...
<script>
      ...
      function confirmDeleteLocal(venta_id) {
      Swal.fire({
          title: '¿Estás seguro?',
