            ...
            <tbody>
              ...
              foreach ($lista_cliente as $registro) {?>
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info" href="editar.php?txtID=<?php echo $registro['cliente_id']; ?>"role="button" title="Editar">
                        <i class="fas fa-edit"></i>Editar
                    </a>
                    <a class="btn btn-danger"href="index.php?txtID=<?php echo $registro['cliente_id']; ?>" role="button" title="Eliminar">
